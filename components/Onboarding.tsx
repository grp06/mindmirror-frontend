...
const Onboarding: React.FC = () => {
  const { onboarding, completeOnboarding, updateOnboardingStep } = useAppContext();

  console.log('Onboarding component rendered with state:', onboarding);
    ...
    switch (onboarding.currentStep) {
      case OnboardingStep.Privacy:
        return {
          ...
          subtitle: "Your journal entries are only sent to OpenAI for processing and are never stored on our servers",
          icon: "🔒",
        };
      case OnboardingStep.Usage:
        return {
          title: "How to Use MindMirror",
          subtitle: "Write in your Daily Note and click refresh for AI feedback. Open the menu in the bottom right to customize your experience - choose different therapy styles, insight types, and adjust the tone of your feedback.",
          icon: "💡",
        };
      case OnboardingStep.Emotions:
        return {
          title: "Track Your Emotions",
          subtitle: "Click the heart icon in the bottom right corner to open the emotions bar. Your selected emotions will be integrated into your therapy insights for more personalized feedback.",
          icon: "❤️",
        };
    ...
    <OnboardingOverlay>
      <OnboardingCard>
        ...
        <OnboardingButton onClick={handleNext}>
          {onboarding.currentStep === OnboardingStep.Complete ? "Get Started" : "Next"}
        </OnboardingButton>
      </OnboardingCard>
    </OnboardingOverlay>
  );
